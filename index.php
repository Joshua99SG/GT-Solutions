        ...
        <div class="search-section table-container">
            <div class="row d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary col-2" data-bs-toggle="modal"
                    data-bs-target="#crearModal">Agregar cliente</button>
                <div class="modal fade" id="crearModal" tabindex="-1" aria-labelledby="crearModalLabel"
                    aria-hidden="true">
                                ...
                                <form action="index.php" method="post" id="form_create">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-12 col-md-4">
                                            <label for="velocidad_contratada" class="form-label">Velocidad
                                                Contratada:</label>
                                            <input type="text" class="form-control" id="velocidad_contratada"
                                                name="velocidad_contratada">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-3 col-12 col-md-4">
                                        ...
                                        <div class="mb-3 col-12 col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="id_tipo_cliente"
                                                name="id_tipo_cliente">
                                        </div>
                                        <div class="mb-3 col-12 col-md-4">
                                            <label for="sector_anclado" class="form-label">Sector Anclado:</label>
                                            <input type="text" class="form-control" id="sector_anclado"
                                                name="sector_anclado">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-12 col-md-4">
                                            ...
                                            <input type="password" class="form-control" id="wifi_contrasena"
                                                name="wifi_contrasena">
                                        </div>
                                        <div class="mb-3 col-12 col-md-4">
                                            <label for="contrasena_ppoe" class="form-label">Contraseña PPOE:</label>
                                            <input type="password" class="form-control" id="contrasena_ppoe"
                                                name="contrasena_ppoe">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="mac_address_1"
                                                name="mac_address_1">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="mac_address_2"
                                                name="mac_address_2">
                                        </div>
                            ...
                            <div class="table-responsive" id="div_candidates">
                                <table id="tablaClientes" class="table table-striped">
                                    <thead style="background-color: #006AF9;">
                                        <tr>
                                            <th><input type="checkbox" class="no-sort form-check-input custom-checkbox"
                                                    id="checkAll" onclick="check_candidates()"></th>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input custom-checkbox"
                                                        id="checkbox-${i + 1}" onclick="get_all_checked_candidates()">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="dropdown-item" data-bs-toggle="modal"
                                                                    data-bs-target="#editarModal<?php echo $cliente['id_cliente']; ?>">Editar</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item link_delete"
                                                                    data-id="<?php echo $cliente['id_cliente']; ?>">Eliminar</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="modal fade"
                                                        id="editarModal<?php echo $cliente['id_cliente']; ?>" tabindex="-1"
                                                        aria-labelledby="editalModal<?php echo $cliente['id_cliente']; ?>Label"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-xl">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form action="index.php" method="post"
                                                                        id="form_edit_<?php echo $cliente['id_cliente']; ?>">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="localidad"
                                                                                    value="<?php echo $cliente['localidad']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                <label for="coordenadas"
                                                                                    class="form-label">Coordenadas:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="coordenadas"
                                                                                    value="<?php echo $cliente['coordenadas']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                <label for="velocidad_contratada"
                                                                                    class="form-label">Velocidad
                                                                                    Contratada:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="velocidad_contratada"
                                                                                    value="<?php echo $cliente['velocidad_contratada']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="numero_contrato"
                                                                                    value="<?php echo $cliente['numero_contrato']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="id_tipo_cliente"
                                                                                    value="<?php echo $cliente['id_tipo_cliente']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                <label for="sector_anclado"
                                                                                    class="form-label">Sector
                                                                                    Anclado:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="sector_anclado"
                                                                                    value="<?php echo $cliente['sector_anclado']; ?>">
                                                                            </div>

                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                <label for="wifi_nombre"
                                                                                    class="form-label">Nombre de
                                                                                    WiFi:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="wifi_nombre"
                                                                                    value="<?php echo $cliente['wifi_nombre']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                <label for="contrasena_ppoe"
                                                                                    class="form-label">Contraseña
                                                                                    PPOE:</label>
                                                                                <input type="password" class="form-control"
                                                                                    name="contrasena_ppoe"
                                                                                    value="<?php echo $cliente['contrasena_ppoe']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-4">
                                                                                <label for="wifi_contrasena"
                                                                                    class="form-label">Contraseña de
                                                                                    WiFi:</label>
                                                                                <input type="password" class="form-control"
                                                                                    name="wifi_contrasena"
                                                                                    value="<?php echo $cliente['wifi_contrasena']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="mb-3 col-12 col-md-6">
                                                                                <label for="equipo_1"
                                                                                    class="form-label">Equipo 1:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="equipo_1"
                                                                                    value="<?php echo $cliente['equipo_1']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-6">
                                                                                <label for="mac_address_1"
                                                                                    class="form-label">MAC Address
                                                                                    1:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="mac_address_1"
                                                                                    value="<?php echo $cliente['mac_address_1']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="mb-3 col-12 col-md-6">
                                                                                <label for="equipo_2"
                                                                                    class="form-label">Equipo 2:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="equipo_2"
                                                                                    value="<?php echo $cliente['equipo_2']; ?>">
                                                                            </div>
                                                                            <div class="mb-3 col-12 col-md-6">
                                                                                <label for="mac_address_2"
                                                                                    class="form-label">MAC Address
                                                                                    2:</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="mac_address_2"
                                                                                    value="<?php echo $cliente['mac_address_2']; ?>">
                                                                            </div>
                                                                        </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="mb-3 col-12 col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="equipo_3"
                                                                            value="<?php echo $cliente['equipo_3']; ?>">

                                                                    </div>
                                                                    <div class="mb-3 col-12 col-md-6">
                                                                        <label for="serie" class="form-label">Serie:</label>
                                                                        <input type="text" class="form-control" name="serie"
                                                                            value="<?php echo $cliente['serie']; ?>">
                                                                    </div>
                                                                    </form>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn_edit"
                                                                        data-id="<?php echo $cliente['id_cliente']; ?>">Guardar</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <form action="index.php" method="post"
                                                            id="form_delete_<?php echo $cliente['id_cliente']; ?>">
